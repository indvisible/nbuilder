...
namespace Indvisible.RealisticData
{
    public static class Company
    {
        ...
        {
            return CatchPre.Rand() + " " + CATCH_MID.Rand() + " " + CATCH_POS.Rand();
        }
        ...
        static readonly string[] CatchPre = new[] { "Adaptive", "Advanced", "Ameliorated", "Assimilated",
