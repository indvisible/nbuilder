...
namespace Indvisible.RealisticData
{
    public static class Name
    {
        ...
        {
            switch (DataRandom.Rand.Next(10))
            {
        ...
        static readonly string[] FirstNames = new[] {"Aaliyah", "Aaron", "Abagail", "Abbey", "Abbie", "Abbigail", "Abby", "Abdiel", "Abdul",
        ...
        static readonly string[] LastNames = new[] {"Abbott", "Abernathy", "Abshire", "Adams", "Altenwerth", "Anderson",
